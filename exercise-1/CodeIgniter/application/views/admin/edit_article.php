...
$attr = array("method"=>"post","class"=>"ayush", "id"=>"form");
 echo form_open_multipart('admin/update_article',$attr);
echo form_hidden('id',$articles[0]['id']);
  ...
  <fieldset>
	...
	<div class="form-group">
	<?php 
	$atrrib = array("class"=>"form-control", "id"=>"exampleInputEmail1", "placeholder"=>"Enter Title","name"=>"title","value"=>set_value('title',$articles[0]['title']));
...
<?php echo form_error("title");?>
    ...
    <div class="form-group">
      <label for="exampleTextarea">Description</label>
		<?php 
			$attr = array("name"=>"desc","rows"=>"3","value"=>set_value('desc',$articles[0]['body']), "class"=>"form-control");
